...
public class Lexer {
    ...
    public static final List<String> KEYWORDS = List.of("exit", "import", "id", "dom", "cod", "cat", "let", "assume", "prove", "apply", "property", "theorem", "search", "use", "with", "then", "def", "exists", "check", "debug");
